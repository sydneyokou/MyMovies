...
import { StyleSheet, View, Text, ActivityIndicator, ScrollView, Image, TouchableOpacity ,Platform, Share} from 'react-native' // L'api share permet de partager des élèments avec un titre + message
...
class FilmDetail extends React.Component {
  ...
  componentDidMount() {
    ...
    if (favoriteFilmIndex !== -1) { // Film déjà dans nos favoris, on a déjà son détail
      ...
      },() => { this._updateNavigationParams() })   // Dès que le film est chargé, on met à jour les paramètres de la navigation (avec la fonction _updateNavigationParams) pour afficher le bouton de partage
      return
    }
  ...
  _shareFilm(){
    ...
    Share.share({title: film.title, message: film.title + "\n"+ film.overview})
  }
